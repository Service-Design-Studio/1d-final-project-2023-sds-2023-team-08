Feature: Frontend Cucumber
  ...
  Scenario: Filter button 0 filters correctly to "539-23421-0"
    Given I am at the Recent Trasanctions page and I want to filter by "539-23421-0"
    When I click on the filter button by account number "539-23421-0"
    Then I will see that only transactions under account "539-23421-0" are shown
  ...
  Scenario: Clicking out of "539-23421-0" button 0 works
    Given I have filtered my transactions by "539-23421-0"
    When I click on the greyed-out filter button by account number "539-23421-0"
    Then I will see that all my transactions from both accounts will be shown and "539-23421-0" button is white
