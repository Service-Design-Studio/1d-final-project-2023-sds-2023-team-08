...
Feature: Making a Paynow Transfer dispute -> send wrong account > click redirect link > vertexai > full refund
...
# Feature: Resolve a Paynow Transfer dispute -> dashboard > FTD status page > partial refund
