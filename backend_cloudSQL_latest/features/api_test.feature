...
Scenario: Verify URL 1 returns expected JSON
    Given that I send a GET request to "http://127.0.0.1:8080/users/1/home"
...
Scenario: Verify URL 2 returns expected JSON
    Given that I send a GET request to "http://127.0.0.1:8080/users/1/all-transactions-7-days"
    Then the response should be a JSON
...
Scenario: Accessing an Invalid URL
    Given that I send a GET request to "http://127.0.0.1:8080/users/32/home10"
    Then I should receive a 404 error

Scenario: Keying in an invalid user ID
    Given that I send a GET request to "http://127.0.0.1:8080/users/999/home"
    Then I should receive a 404 error
