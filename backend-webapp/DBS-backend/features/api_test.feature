...
Scenario: Verify URL 1 returns expected JSON
    Given that I send a GET request to "http://127.0.0.1:8080/users/17/home"
...
Scenario: Verify URL 2 returns expected JSON
    Given that I send a GET request to "http://127.0.0.1:8080/users/17/all_transactions"
    Then the response should be a JSON
...
Scenario: Accessing an Invalid URL
    Given that I send a GET request to "http://127.0.0.1:8080/users/17/home10"
