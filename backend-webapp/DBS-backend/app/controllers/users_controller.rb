      ...
      data.push(
        {
          ...
          "transaction": {
            "transaction name": transaction.account.user.id==@user.id ? transaction.transaction_name+" TO: "+transaction.get_other_party_name: transaction.transaction_name+" from: "+transaction.account.user.username,
            "transaction type": transaction.transaction_type,
            "account number": transaction.account.user.id==@user.id ? transaction.account.account_number : transaction.recipient_account_number,
